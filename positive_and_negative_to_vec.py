with open('train/3663_positive_pair.txt') as pid:
    positive_LPI1 = pid.readlines()
with open('train/3663_location_negative_pair.txt') as pid:
    negative_LPI1 = pid.readlines()
with open('test/915_positive_pair.txt') as pid:
    positive_LPI2 = pid.readlines()
with open('test/915_location_negative_pair.txt') as pid:
